...
fun Collection<DomainEvent>.recreate(): CounterAggregate =
    this.onEach { println(it.type) }
...
fun Collection<DomainEvent>.restoreFromSnapshot(snapshot: CounterAggregate): CounterAggregate =
    this.fold(snapshot) { acc, domainEvent ->
